			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.servicios.create') }}" class="btn green">
                                Agregar registro
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.servicios.edit', $item->id) }}">Editar</a></li>
...
{!! Form::open(['route' => ['admin.servicios.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
...
{!! Form::open(['route' => ['admin.servicios.publicar', ':REGISTER'], 'method' => 'PUT', 'id' => 'FormPublicarRow']) !!}
{!! Form::close() !!}
