    ...
    <div class="col-lg-12">
        ...
        <div class="portlet box blue-hoki">
            ...
            <div class="portlet-body form">
                {!! Form::open(['route' => 'admin.servicios.store', 'method' => 'POST', 'class' => 'form-horizontal form-bordered', 'files' => 'true']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            {!! Form::select('proveedor', ['' => 'Seleccionar'] + $provider, $selected, ['class' => 'form-control']) !!}
                        </div>
                    </div>

                    <div class="form-group">
                        {!! Form::label('costo_tot_servicio', 'Costo Total de Servicio', ['class' => 'col-md-3 control-label']) !!}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('pais', ['' => 'Seleccionar'] + $pais, $selected, ['class' => 'form-control select2']) !!}
                        </div>
                    </div>
