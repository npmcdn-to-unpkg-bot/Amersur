		...
		<div class="col-lg-12">
			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body">
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.pages.index', 'method' => 'GET']) !!}
                        ...
                        <tbody>
                            ...
                            <tr data-id="{{ $item->id }}" data-title="{{ $item->titulo }}">
                                ...
                                <td class="text-center">
                                    <a title="Editar" href="{{ route('admin.pages.edit', $item->id) }}" class="btn default btn-xs blue"><i class="fa fa-edit"></i></a>
...
{!! Form::open(['route' => ['admin.pages.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
