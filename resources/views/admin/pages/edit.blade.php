	...
	<div class="col-lg-12">
		...
		<div class="portlet box blue-hoki">
			...
			<div class="portlet-body form">
				{!! Form::model($post, ['route' => ['admin.pages.update', $post->id], 'method' => 'PUT', 'class' => 'form-horizontal form-bordered', 'files' => 'true']) !!}
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-right">
                            ...
                            <a href="{{ route('admin.pages.history', $post->id) }}" class="btn green">Historial de cambios</a>
                        </div>
                    </div>
