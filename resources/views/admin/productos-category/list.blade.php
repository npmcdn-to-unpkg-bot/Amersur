            ...
            <div class="portlet box blue-hoki">
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.productos-category.create') }}" class="btn green">
                                Agregar registro
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.productos-category.index', 'method' => 'GET']) !!}
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center col-md-2">
                                        ...
                                        <a href="{!! route('admin.productos-category.index') !!}" class="btn btn-danger">
                        ...
                        <tbody>
                            ...
                            <tr data-id="{{ $item->id }}" data-title="{{ $item->titulo }}">
                                ...
                                <td class="text-center">
                                    <a title="Editar" href="{{ route('admin.productos-category.edit', $item->id) }}" class="btn default btn-xs blue"><i class="fa fa-edit"></i></a>
...
{!! Form::open(['route' => ['admin.productos-category.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
