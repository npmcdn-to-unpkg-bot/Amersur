            ...
            <div class="portlet box blue-hoki borderNone">
                ...
                <div class="portlet-body">   
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.gallery.photo.photosCreate', $posts->id) }}" class="btn green">
                                Agregar registro
                    ...
                    <div class="table-toolbar">
                        ...
                        {!! Form::open(['route' => ['admin.gallery.photo.photosOrder', $posts->id], 'method' => 'POST', 'id' => 'FormOrder']) !!}
                        ...
                        <ul id="listPhotos" class="unstyled">
                            ...
                            <li data-id="{{ $item->id }}" data-title="{{ $item->titulo }}" class="col-lg-2 col-md-3 col-xs-6 col-sm-3 gallery-border">
                                ...
                                <div class="slider-options">
                                    ...
                                    <a href="{{ route('admin.gallery.photo.photosEdit', [$posts->id, $item->id]) }}" title="Editar">
...
{!! Form::open(['route' => ['admin.gallery.photo.photosDelete', $posts->id, ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
