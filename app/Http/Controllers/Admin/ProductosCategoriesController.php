...
class ProductosCategoriesController extends Controller {
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.productos-category.list', compact('categories'));
    }
    ...
    {
        return view('admin.productos-category.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.productos-category.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.productos-category.edit', compact('category'));
    }
